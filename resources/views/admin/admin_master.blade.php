...
<html lang="en" dir="ltr">
  ...
  <link href="{{asset('backend/assets/plugins/jvectormap/jquery-jvectormap-2.0.3.cs')}}s" rel="stylesheet" />
  <link href="{{asset('backend/assets/plugins/ladda/ladda.min.css')}}" rel="stylesheet" />
  <link href="{{asset('backend/assets/plugins/select2/css/select2.min.css')}}" rel="stylesheet" />
  <link href="{{asset('backend/assets/plugins/daterangepicker/daterangepicker.cs')}}s" rel="stylesheet" />
...
<script src="{{asset('backend/assets/plugins/select2/js/select2.min.j')}} s"></script>
